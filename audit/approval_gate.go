...
// digest should be pre-generated by the caller (audit.CmdDigest) so that all
// log entries for this command share the same correlation token.
func (g *ApprovalGate) Check(ctx context.Context, user, host, remoteIP, sessionID, command, digest string) (approval.Decision, error) {
